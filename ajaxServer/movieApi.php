...
$movieDay = array(
  array("id" => 1, "movieName" => 1, "date" => "2022-12-10"),
  array("id" => 2, "movieName" => 1, "date" => "2022-12-11"),
  array("id" => 3, "movieName" => 2, "date" => "2022-12-11"),
  array("id" => 4, "movieName" => 2, "date" => "2022-12-12"),
  array("id" => 5, "movieName" => 3, "date" => "2022-12-12"),
  array("id" => 6, "movieName" => 3, "date" => "2022-12-13")
);
$movieOrder = array(
